...
OPTIONS.add_argument('--model_path',dest='model_path',type=str, default="/home/wyl/work/journal_mamba/IIMGF_Net/checkpoint/bestacc_0.7734.pth")
# log_path = options['log_path']
...
OPTIONS.add_argument('--beta',dest='beta',type=float,default=0.5)
